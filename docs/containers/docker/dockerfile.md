...
!!! example "Комбинация инструкций CMD и ENTRYPOINT"
    ...
    Если выполнить команду ниже, то результатом будет `echo World`.
...
!!! example "Проверка промежуточного состояния"
...
!!! example "Production-ready пример Dockerfile"
